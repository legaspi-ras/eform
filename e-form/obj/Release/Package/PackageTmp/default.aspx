            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Form Template</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">List of downloadable e-forms templates</li>
                        </ol>
                            ...
                            <div class="card-body">
                                <form runat="server">
                                     <asp:GridView ID="datatablesSimple" runat="server" class="table table-bordered" AutoGenerateColumns="False" EmptyDataText = "No files uploaded">
                                         <Columns>
                                             <asp:BoundField DataField="formDepartment" HeaderText="Department" SortExpression="formDepartment" />
                                             <asp:BoundField DataField="formControlnum" HeaderText="Form Control No." SortExpression="formControlnum" />
                                             <asp:BoundField DataField="formTitle" HeaderText="Form Title" SortExpression="formTitle" />
                                             <asp:BoundField DataField="formRevisionnum" HeaderText="Revision No." SortExpression="formRevisionnum" />
                                             <asp:TemplateField>
                                                 <ItemTemplate>
