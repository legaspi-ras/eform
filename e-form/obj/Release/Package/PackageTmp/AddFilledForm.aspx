<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AddFilledForm.aspx.vb" Inherits="e_form.AddFilledForm" %>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link collapsed bi bi-file-earmark-plus " href="#" >
                                        Add                                  
                                    </a>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Select filled/approved form 
                            </div>
                            <div class="card-body">
                               
                     <asp:DropDownList ID="ddlDepartment1" runat="server" class="form-select" DataTextField="DEPARTMENT" DataValueField="DEPARTMENT" autopostback="true" ToolTip="Please select depeartment" Width="200px">
                         ...
                         <asp:ListItem Value="general">General</asp:ListItem>
                            ...
                            <Columns>
                                <asp:BoundField DataField="Text" HeaderText="File Name" />
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkDownload" Text = "Download" OnClientClick="SetTargetSelf();" CommandArgument = '<%# Eval("Value") %>' runat="server" CommandName="Select"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
<%--                                     <asp:TemplateField>
                                        <ItemTemplate>    
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Update selected filled form
                            </div>
                            <div class="card-body">
                                    <asp:Label ID="lblsuccess" runat="server" style="color:green" class="bi bi-check-circle-fill" Text=" Update Successful." Visible="false"></asp:Label>
            ...
            <tr>
                ...
                <td style=" padding:8px">
                     <asp:TextBox ID="txtDepartment" class="form-control" runat="server"  required ="True" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style=" padding:8px">
                     <asp:TextBox ID="txtFormctrlnum" class="form-control" runat="server" onkeyup="UcaseTxt(this)" ToolTip="Please avoid using spaces" required ="True" ></asp:TextBox>
            ...
            <tr>
                ...
                <td style=" padding:8px">
                    <asp:TextBox ID="txtFormtitle" class="form-control" runat="server" required ="True" ></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style=" padding:8px">
                    <asp:TextBox ID="txtRevnum" class="form-control" runat="server" ToolTip="Use capital letters if necessary" required ="True" ></asp:TextBox>                
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style=" padding:8px">
                    <asp:TextBox ID="txtRevdate" class="form-control" runat="server" ToolTip="Use mm-dd-yyyy format" placeholder="mm-dd-yyyy" required ="True" MaxLength="10"></asp:TextBox>
                </td>
            </tr>

            <tr>
                <td style=" padding:8px">
                     <asp:Label ID="Label4" runat="server" Text="Originator : "></asp:Label>
                </td>
                <td style=" padding:8px">
                    <asp:TextBox ID="txtOriginator" class="form-control" runat="server" ToolTip="Use capital letters if necessary" required ="True" ></asp:TextBox>                
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style=" padding:8px">
                    <asp:FileUpload ID="FileUpload1" class="form-control" runat="server" ToolTip="Please select PDF files only." required ="True"/> <%--AllowMultiple="true" selecting multiple files--%>
                </td>
            </tr>
