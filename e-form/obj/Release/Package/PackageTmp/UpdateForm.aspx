<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UpdateForm.aspx.vb" Inherits="e_form.UpdateForm" %>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Update Form Template</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Update existing form template</li>
                        </ol>
                         <div class="row">
                             <div class="col-lg-6">
                        <div class="card mb-4">
