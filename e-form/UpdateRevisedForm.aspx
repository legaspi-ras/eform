<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UpdateRevisedForm.aspx.vb" Inherits="e_form.UpdateRevisedForm" %>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Update Filled Form</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Update filled form. Note: Please make sure that the filled / approved pdf file print and save fuctioon is disabled.</li>
                        </ol>
                         <div class="row">
                             <div class="col-lg-6">
                        <div class="card mb-4">
...
<%--                                             <asp:TemplateField>
            ...
            <tr>
                <td style=" padding:8px">
                     <asp:Label ID="Label7" runat="server" Text="Filename : "></asp:Label>
                </td>
                <td style=" padding:8px">
                     <asp:TextBox ID="txtFilename" class="form-control" runat="server"  required ="True" Enabled="False"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style=" padding:8px">
            ...
            <tr>
                ...
                <td style=" padding:8px; text-align: left;">
                     <asp:Button ID="btnUpdate" class="btn btn-success" runat="server" Text="Update" Enabled="False" />
                </td>
            </tr>
